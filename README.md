...
[![Deploy to EdgeOne Makers](https://cdnstatic.tencentcs.com/edgeone/pages/deploy.svg)](https://edgeone.ai/makers/new?s_url=https://console.tencentcloud.com/edgeone/makers/new?template=multimodal-file-assistant-agent&from=within&fromAgent=1&agentLang=typescript)
